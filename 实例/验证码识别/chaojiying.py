...
#         'huihuiya', '1127473030zhh', '905113')  # 用户中心>>软件ID 生成一个替换 96001
#     im = open('a.jpg', 'rb').read()  # 本地图片文件路径 来替换 a.jpg 有时WIN系统须要//
#     # 1902 验证码类型  官方网站>>价格体系 3.4+版 print 后要加()
#     print(chaojiying.PostPic(im, 1902))

def transform_Img_Code(img_path,img_type):
    chaojiying = Chaojiying_Client('huihuiya', '1127473030zhh', '905113')
    im = open(img_path, 'rb').read()
    return chaojiying.PostPic(im, img_type)['pic_str']

# print(transform_Img_Code('a.jpg',1902))